    ...
    <main class="px-6 space-y-6">
        ...
        <div class="space-y-3">
            <button 
                ...
                class="w-full py-4 rounded-2xl bg-white border border-slate-200 text-sm font-bold text-slate-700 transition-all flex items-center justify-center gap-2 {{ ($is_off_hours ?? false) ? 'opacity-50 cursor-not-allowed' : 'hover:bg-slate-50 active:scale-[0.98]' }}">
